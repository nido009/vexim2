...
<html>
  ...
  <body>
    ...
    <div id="Menu">
      <a href="mainadmingroupadd.php"><?php echo _('Add Group'); ?></a>
      <br>
    ...
    <div id="Content">
      <table align="center">
        ...
        <tr>
          <td class="trash">
            <a href="mainadmingroupdelete.php?group_id=<?php echo $row['id']; ?>&localpart=<?php echo $row['name']; ?>">
            <img class='trash' title="<?php print _('Delete group') . $row['name']; ?>"
              src="images/trashcan.gif" alt="trashcan">
            </a>
          </td>
          <td>
            <a href="mainadmingroupchange.php?group_id=<?php echo $row['id']; ?>"
              title="<?php print _('Click to modify ') . $row['name']; ?>">
            <?php echo $row['name'].'@'.$_SESSION['local_domain']; ?></a>
          </td>
          <td>
