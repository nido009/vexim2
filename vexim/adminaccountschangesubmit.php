<?php
  ...
  if (!$sth->rowCount()) {
	  header ("Location: adminaccounts.php?failupdated={$_POST['localpart']}");
	  die();  
  }
  ...
  if (($row['count'] == "0") && ($_POST['admin'] == "0")) {
    header ("Location: adminaccounts.php?lastadmin={$_POST['localpart']}");
    die;
  }
  ...
  if ($success) {
    header ("Location: adminaccounts.php?updated={$_POST['localpart']}");
  } else {
    header ("Location: adminaccounts.php?failupdated={$_POST['localpart']}");
  }
?>
