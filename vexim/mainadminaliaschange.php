...
<div id="menu">
<a href="mainadminalias.php"><?php echo _('Manage Aliases'); ?></a><br>
<a href="mainadminaliasadd.php"><?php echo _('Add Alias'); ?></a></br>
...
echo "Invalid alias userid '" . htmlentities($_GET['user_id']) . "' for domain '" . htmlentities($_SESSION['local_domain']). "'";	
echo '</td></tr></table>';
}else{	
?>
<form name="aliaschange" method="post" action="mainadminaliaschangesubmit.php">
<table align="center">
<tr>
...
@<?php print $_SESSION['local_domain']; ?>
</td>
</tr>
<tr>
<td>
