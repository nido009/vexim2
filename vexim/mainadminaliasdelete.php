<?php
  ...
  if(array_key_exists('confirm', $_GET)) {
    if ($_GET['confirm'] == '1') {
      ...
      if ($success) {
        header ("Location: mainadminalias.php?deleted={$_GET['localpart']}");
        die;
      } else {
        header ("Location: mainadminalias.php?faildeleted={$_GET['localpart']}");
        die;
      }
...
<html>
  <head>
    ...
    <div id="Content">
      <form name="aliasdelete" method="get" action="mainadminaliasdelete.php">
        <table align="center">
          <tr>
            <td colspan="2">
