...
<?php
  ...
  $sth->execute(array(':group_id'=>$_GET['group_id'], ':domain_id'=>$_SESSION['local_domain_id']));
  if($sth->rowCount()) {
    $row = $sth->fetch();
...
<html>
  ...
  <body onLoad="document.groupchange.realname.focus()">
    ...
    <div id="menu">
      <a href="mainadmingroup.php"><?php echo _('Manage Groups'); ?></a><br>
      <a href="mainadmingroupadd.php"><?php echo _('Add Group'); ?></a></br>
	...
	<?php 
		...
		if (!$sth->rowCount()) {			
			...
			echo "Invalid groupid '" . htmlentities($_GET['group_id']) . "' for domain '" . htmlentities($_SESSION['local_domain']). "'";			
			echo '</td></tr></table>';
		}else{
	?>	
      <table align="center">
        <form name="groupchange" method="post"
          action="mainadmingroupchangesubmit.php">
        <tr>
          <td><?php echo _('Group Address'); ?>:</td>
          <td>
            <input name="localpart" type="text"
              value="<?php echo $row['name']; ?>"class="textfield">@
              <?php echo $_SESSION['local_domain']; ?>
        ...
        <tr>
          <td colspan="2"> 
            ...
            <table align="center">
              ...
              <tr>
                <td class="trash">
                  <a href="mainadmingroupcontentdeletesubmit.php?group_id=<?php echo $_GET['group_id'];
          ...
          <form method="post" action="mainadmingroupcontentaddsubmit.php"
