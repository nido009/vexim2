...
?>
		...
		<form name="userchange" method="post" action="adminuserchangesubmit.php">
			...
			<tr>
				...
				<td><input type="password" size="25" id="clear" name="clear" class="textfield"></td>
			</tr>
			<tr>
...
<?php
			echo _('When you update the UID or GID, please make sure
...
?>
			<tr>
				<td>
<?php 
		printf (_('Mailbox quota (%s MB max)'),
			$domrow['quotas']);
?>
				:</td>
				<td>
...
?>
			<tr>
				...
				<td><input type="textfield" size="25" name="smtp" class="textfield" value="<?php echo $row['smtp']; ?>"></td>
			</tr>
			<tr>
				<td colspan="2" style="padding-bottom:1em">
					<?php echo _('Optional');?>: <?php echo _('Pipe all mail to a command (e.g. procmail).');?>
					<br>
...
?>
			...
			<tr>
				...
				<td>
					<input type="text" size="5" name="sa_tag" value="<?php echo $row['sa_tag']; ?>" class="textfield">
				</td>
			</tr>
			<tr>
				<td><?php echo _('Spamassassin refuse score'); ?>:</td>
				<td>
					<input type="text" size="5" name="sa_refuse" value="<?php echo $row['sa_refuse']; ?>" class="textfield">
				</td>
			</tr>
<?php
		}
?>
			<tr>
				...
				<td>
					<input type="text" size="5" name="maxmsgsize" value="<?php echo $row['maxmsgsize']; ?>" class="textfield">Kb
				</td>
			</tr>
<?php
	}
...
?>
				...
				<td><textarea name="vacation" cols="40" rows="5" class="textfield"><?php print imap_qprint($row['vacation']); ?></textarea></td>
<?php 
		} else { 
?>
				<td><?php echo _('Vacation message (ASCII only!)'); ?>:</td>
				<td><textarea name="vacation" cols="40" rows="5" class="textfield"><?php print $row['vacation']; ?></textarea></td>
<?php
		} 
?>
			</tr>
